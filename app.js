...
const legalContents = {
  ...
  terms: {
    ...
    body: `
      <h3>一、網站用途</h3>
      <p>本網站為「2026 第五屆 Kilaing tjai Yisu－作和平的使者」系列活動官方資訊及報名網站，由東部排灣中會青年大專部維護，提供青年領袖輔導培訓營、日光暑期兒童營之活動介紹、日程安排、線上報名及聯絡資訊。</p>

      <h3>二、活動資訊</h3>
      <p>本網站所列活動日期、地點、講師、課程及流程，可能因天候、場地、交通或其他實際情況調整。如有異動，將由主辦單位另行通知，並以主辦單位最新公告為準。</p>

      <h3>三、報名資料</h3>
      <p>報名者應確認所填資料正確且完整。若因資料錯誤、缺漏或聯絡方式無法使用，影響活動通知、保險、接送、住宿或其他行政安排，主辦單位將依實際情況協助處理。</p>
      <p>本網站所蒐集之個人資料，將依「隱私權與個人資料蒐集告知」所載內容處理及利用。</p>

      <h3>四、活動影像與情境插畫</h3>
      <p>本網站部分插畫以歷年真實活動影像為基礎，經數位轉繪與視覺風格化處理，用於呈現營隊中的學習、陪伴、互動與服事情境。</p>
      <p>相關插畫為活動精神與情境之視覺呈現，不代表本年度實際參加者、講師、場地配置或活動當日完整樣貌。實際活動內容請以主辦單位公告及現場安排為準。</p>

      <h3>五、外部連結</h3>
      <p>本網站可能提供 Google Maps、Instagram 或其他外部網站連結。使用者進入外部網站後，其服務、內容及個人資料處理方式，應依各網站之使用條款與隱私權政策辦理。</p>

      <h3>六、網站內容與使用</h3>
      <p>本網站所使用之文字、活動識別、圖像、插畫及版面設計，除另有註明外，均供本系列活動宣傳與資訊傳達使用。未經主辦單位同意，請勿擅自重製、修改、散布或作其他用途。</p>

      <h3>七、網站服務</h3>
      <p>主辦單位將盡力維持網站資訊正確及服務正常，但網站仍可能因系統維護、網路中斷、第三方服務異常或其他不可預期因素暫停運作。</p>

      <h3>八、聯絡方式</h3>
      <p>如對網站內容、活動資訊、報名資料或相關權益有疑問，請聯絡：</p>
      <p>東部排灣中會青年大專部<br>電子信箱：<a href="mailto:cpcyouth2026@gmail.com">cpcyouth2026@gmail.com</a></p>
    `,
  },
};
